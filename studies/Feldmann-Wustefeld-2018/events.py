...
#FELDMANN2018_PATH_BEHAVIOR = 'G:\\CDA Datasets\\Feldmann-Westefel 2018\\AnalysisPipeline\\'
FELDMANN2018_PATH_BEHAVIOR = '/Volumes/Nick - Data/CDA Datasets/Feldmann-Westefel 2018/AnalysisPipeline/'
...
def get_specific_events(events, conds, sides, perfs, triggers, subject_id, internal_triggers, experiment=1,):
    if experiment == 1:
        behavfilepath = FELDMANN2018_PATH_BEHAVIOR + 'Experiment1/rawBehavior/{}_Hudson_main.mat'.format(subject_id)
    elif experiment == 2:
        behavfilepath = FELDMANN2018_PATH_BEHAVIOR + 'Experiment2/rawBehavior/{}_Hudson2_main.mat'.format(subject_id)
